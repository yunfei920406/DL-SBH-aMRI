...
# This script is an optimized adaptation of the DiffusionModelUNet from the MONAI Consortium.
# It has been streamlined to remove unused modules based on specific model configuration.
# Original MONAI implementation: https://github.com/Project-MONAI/MONAI
